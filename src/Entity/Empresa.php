...
class Empresa
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Oferta", mappedBy="OfertaEmpresa")
     */
    private $ofertas;
    ...
    public function removeOferta(Oferta $oferta): self
    {
        if ($this->ofertas->contains($oferta)) {
            ...
            if ($oferta->getOfertaEmpresa() === $this) {
                $oferta->setOfertaEmpresa(null);
            }
        }
